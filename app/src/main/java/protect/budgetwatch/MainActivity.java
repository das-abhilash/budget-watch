...
import protect.budgetwatch.info.EvaluateSlide1;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        menuItems.add(new MainMenuItem(R.drawable.transaction, R.string.goalsTitle,
                R.string.goalDescription));
        menuItems.add(new MainMenuItem(R.drawable.transaction, R.string.purchaseTitle,
                R.string.purchaseDescription));
        menuItems.add(new MainMenuItem(R.drawable.transaction, R.string.rewardTitle,
                R.string.rewardDescription));
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                switch (item.menuTextId) {
                    ...
                    case R.string.transactionsTitle:
                        ...
                        break;
                    case R.string.purchaseTitle:
                        goalClass = EvaluateSlide1.class;
                        break;
                    case R.string.rewardTitle:
                        goalClass = RewardActivity.class;
                        break;
                    default:
